...
function lose() {
    if (
        ...
        resultDisplay.innerHTML = '<span class="lose-text">💀 GAME OVER!</span>';
        endGame();
    }
}
...
function win() {
    if (squares[currentIndex].classList.contains('ending-block')) {
        resultDisplay.innerHTML = '<span class="win-text">🎉 YOU WIN!</span>';
        endGame();
    }
}
...
startPauseButton.addEventListener('click', () => {
    if (timerId) {
        ...
        if (startPauseButton.textContent === 'RESTART GAME') {
            resetGame();
            return;
        }
